...
class Review(models.Model):
    ...
    calificacion = models.DecimalField(null=False, decimal_places=1, max_digits=3, default=0)
    fecha = models.DateTimeField(null=False)
    gradoVeracidad = models.DecimalField(null=False, decimal_places=1, max_digits=3, default=0)
    ...
    calificacionDiseno = models.DecimalField(null=True, decimal_places=1, max_digits=3, default=0)
    calificacionUsabilidad = models.DecimalField(null=True, decimal_places=1, max_digits=3, default=0)
